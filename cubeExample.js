...
function main() {
    ...
    const armorTexture = loader.load('./12-medieval-signs/armor.png');
    const evilEyeTexture = loader.load('./12-medieval-signs/evil-eye.png');
    const itemsTexture = loader.load('./12-medieval-signs/items.png');
    const magicTexture = loader.load('./12-medieval-signs/magic.png');
    const magicStarTexture = loader.load('./12-medieval-signs/magic-star.png');
    const scrollTexture = loader.load('./12-medieval-signs/scroll.png');
    const mysteryTexture = loader.load('./interrogation.png');
