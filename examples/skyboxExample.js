...
//Defining the skybox
const texture_ft = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_ft.jpg');
const texture_bk = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_bk.jpg');
const texture_up = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_up.jpg');
const texture_dn = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_dn.jpg');
const texture_rt = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_rt.jpg');
const texture_lf = new THREE.TextureLoader().load('../resources/penguins-skybox-pack/penguins (35)/torture_lf.jpg');
