...
function main() {
...

    {
        ...
        const texture = loader.load('../resources/mayhem/afterrain_dn.jpg');
...

    {
        ...
        mtlLoader.load('../resources/blender_models/seagull/seagull-low-poly.mtl', (mtlParseResult) => {
            const objLoader = new OBJLoader2();
            const materials =  MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
            objLoader.addMaterials(materials);
            objLoader.load('../resources/blender_models/seagull/seagull-low-poly.obj', (root) => {
                root.position.set(200, 1200, 0);
                seagullOrbit.add(root);
            });
        });
        mtlLoader.load('../resources/blender_models/windmill/windmill.mtl', (mtlParseResult) => {
            const objLoader = new OBJLoader2();
            const materials =  MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
            objLoader.addMaterials(materials);
            objLoader.load('../resources/blender_models/windmill/windmill.obj', (root) => {
                scene.add(root);
